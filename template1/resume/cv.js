...
document.getElementById('resumeLink2').innerHTML = `<i  class="fa-brands fa-linkedin" aria-hidden="true"></i> <a href="${data.linkedin}" target="_blank" style="color: white;">LinkedIn</a>`;
document.getElementById('resumeLink3').innerHTML = `<i class="fa fa-envelope" aria-hidden="true"></i> ${data.email}`;
document.getElementById('resumeLink4').innerHTML = `<i class="fa-solid fa-link-simple" aria-hidden="true"></i> <a href="${data.portfolio}" target="_blank" style="color: white;">${data.portfolio}</a>`;
